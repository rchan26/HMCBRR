...
#include "stanExports_bayes_robust_reg.h"

RCPP_MODULE(stan_fit4bayes_robust_reg_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_bayes_robust_reg")
