...
namespace model_bayes_robust_reg_namespace {
using std::istream;
using std::string;
...
class model_bayes_robust_reg
  : public stan::model::model_base_crtp<model_bayes_robust_reg> {
private:
        int nsamples;
        int p;
        vector_d y;
        ...
        double const2;
public:
    model_bayes_robust_reg(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bayes_robust_reg_namespace::model_bayes_robust_reg";
        ...
        try {
            ...
            pos__ = 0;
            nu = vals_r__[pos__++];
            check_greater_or_equal(function__, "nu", nu, 2);
        ...
        try {
            ...
            for (size_t j_1__ = 0; j_1__ < diff_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(diff(j_1__))) {
                    ...
                    msg__ << "Undefined transformed parameter: diff" << "(" << j_1__ << ")";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_bayes_robust_reg_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_bayes_robust_reg_namespace::model_bayes_robust_reg stan_model;
#ifndef USING_R
